...
impl MessageBatchClient for AnthropicClient {
    ...
    /// use zapmyco_anthropic_ai_sdk::types::message_batches::{
    ...
    /// ```no_run
    /// use zapmyco_anthropic_ai_sdk::client::AnthropicClient;
    /// use zapmyco_anthropic_ai_sdk::types::message_batches::{MessageBatch, MessageBatchClient, MessageBatchError};
    ///
    /// async fn example() -> Result<(), Box<dyn std::error::Error>> {
    ...
    /// ```no_run
    /// use zapmyco_anthropic_ai_sdk::client::AnthropicClient;
    /// use zapmyco_anthropic_ai_sdk::types::message_batches::{MessageBatch, MessageBatchClient, MessageBatchError, RetrieveMessageBatchParams};
    ///
    /// async fn example() -> Result<(), Box<dyn std::error::Error>> {
    /// let client = AnthropicClient::new::<MessageBatchError>("your-api-key", "2023-06-01")?;
    ...
    /// ```no_run
    /// use zapmyco_anthropic_ai_sdk::client::AnthropicClient;
    /// use zapmyco_anthropic_ai_sdk::types::message_batches::{MessageBatch, MessageBatchClient, MessageBatchError, RetrieveMessageBatchResultsParams};
    ///
    /// async fn example() -> Result<(), Box<dyn std::error::Error>> {
    /// let client = AnthropicClient::new::<MessageBatchError>("your-api-key", "2023-06-01")?;
    ...
    /// ```no_run
    /// use zapmyco_anthropic_ai_sdk::client::AnthropicClient;
    /// use zapmyco_anthropic_ai_sdk::types::message_batches::{CancelMessageBatchParams, MessageBatchClient, MessageBatchError};
    ///
    /// async fn example() -> Result<(), Box<dyn std::error::Error>> {
    /// let client = AnthropicClient::new::<MessageBatchError>("your-api-key", "2023-06-01")?;
    ...
    /// ```no_run
    /// use zapmyco_anthropic_ai_sdk::client::AnthropicClient;
    /// use zapmyco_anthropic_ai_sdk::types::message_batches::{DeleteMessageBatchParams, MessageBatchClient, MessageBatchError};
    ///
    /// async fn example() -> Result<(), Box<dyn std::error::Error>> {
    /// let client = AnthropicClient::new::<MessageBatchError>("your-api-key", "2023-06-01")?;
